        ...
        <div className="flex flex-col gap-5" id="footer-col-1">
          ...
          <div className="flex items-center gap-3 mt-2" id="footer-socials">
            <a 
              ...
              target="_blank" 
              rel="noreferrer" 
              className="w-10 h-10 rounded-full bg-[#1877F2] hover:scale-110 flex items-center justify-center transition-all shadow-lg overflow-hidden"
            ...
            <a 
              href="https://youtube.com/@joyfastfly?si=tvwjpfsdG9lPKrj7" 
              target="_blank" 
              rel="noreferrer" 
              className="w-10 h-10 rounded-full bg-[#FF0000] hover:scale-110 flex items-center justify-center transition-all shadow-lg overflow-hidden"
